                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 mb-4">
                            <div className="pricing-cards">
                                ...
                                <div className="pricing-footers">
                                    <a href="javascript:void(0);0" className="btn btn-outline-primary w-100">Get Started</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 mb-4">
                            <div className="pricing-cards">
                                ...
                                <div className="pricing-footers">
                                    <a href="javascript:void(0);0" className="btn btn-secondary w-100">Get Started</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 mb-4">
                            <div className="pricing-cards">
                                ...
                                <div className="pricing-footers">
                                    <a href="javascript:void(0);0" className="btn btn-info w-100">Get Started</a>
                                </div>
                            </div>
                        </div>
